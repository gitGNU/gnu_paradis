...
import org.nongnu.paradis.local.Properties;
...
public class PacmanDatabase implements Blackboard.BlackboardObserver
{
     ...
     */ public static final String DATABASE_DEPS = Pacman.DATABASE_DEPS;
    
    /** List only packages installed explicitly
     */ public static final String DATABASE_EXPLICIT = Pacman.DATABASE_EXPLICIT;
    
    /** Lists files install by the package
     */ public static final String DATABASE_FILES = Pacman.DATABASE_FILES;
    
    /** Only return installed pacakges
     */ public static final String DATABASE_INSTALLED = Pacman.DATABASE_INSTALLED;
    
    /** Do not return installed pacakges
     */ public static final String DATABASE_NONINSTALLED = Pacman.DATABASE_NONINSTALLED;
     ...
     */ public static final String DATABASE_SEARCH = Pacman.DATABASE_SEARCH;
    ...
    public void messageBroadcasted(final Blackboard.BlackboardMessage message)
    {
        ...
        if (options.contains(DATABASE_ADD))
            ...
            search(options, packages, System.out);
    }
    ...
    public static void search(final Set<String> options, final List<String> packages, final PrintStream out)
    {
        ...
        common.loadDatabase(new FilenameFilter()
                {
                    /** Regex pattern
        ...
        for (final VersionedPackage pack : common.databaseVector)
        {   out.println(pack.toString());
            if (files)
                try
                {   final PackageInfo info = PackageInfo.fromFile(common.packageMap.get(pack));
